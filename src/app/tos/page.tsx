    ...
    <PolicyLayout title="Terms of Service">
      <div className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          Social Media Service. Dodopayments.com does not bear any liability for
          the same.
        </p>
        ...
        <p>
          ...
          exclusive property of <strong>DataGrid Softwares LLP</strong> and are
        ...
        <p>
          ...
          <a href="mailto:admin@datagrids.in">admin@datagrids.in</a>. Upon
          receipt of a notification, the Company will take whatever action, in
          its sole discretion, it deems appropriate, including removing the
        ...
        <p>
          ...
          both the Country and foreign countries. This is following the
          recommendation made by dodopayments.com.
        </p>
        ...
        <p>
          ...
          disclose, sublicense, distribute, modify, and exploit such Feedback
          without restriction.
        </p>
        ...
        <p>
          ...
          trade practice. This has been generated by dodopayments.com. Without

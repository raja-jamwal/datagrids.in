    ...
    <PolicyLayout title="Terms of Service">
      <div className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          Conditions, then you may not access the Service. This acknowledgement
        ...
        <p>
          ...
          Service. Dodopayments.com does not bear any liability for the same.
        </p>
        ...
        <p>
          ...
          property of <strong>DataGrid Softwares LLP</strong> and are protected by
        ...
        <p>
          ...
          <a href="mailto:admin@datagrids.in">admin@datagrids.in</a>. Upon receipt
          of a notification, the Company will take whatever action, in its sole
          discretion, it deems appropriate, including removing the challenged
        ...
        <p>
          ...
          the Country and foreign countries. This is following the recommendation
          made by dodopayments.com.
        </p>
        ...
        <p>
          ...
          to the Company. If for any reason such assignment is ineffective, You
          ...
          sublicense, distribute, modify, and exploit such Feedback without
          restriction.
        </p>
        ...
        <p>
          ...
          This has been generated by dodopayments.com. Without limitation to the
        ...
        <p>
          ...
          efforts to provide at least 30 days' notice before any new terms take
